...
IBC_API scene_view_type scene_view_get_type(scene_view_handle handle);
IBC_API void scene_view_set_type(scene_view_handle handle, scene_view_type view_type);
IBC_API float scene_view_get_fov(scene_view_handle handle);
IBC_API void scene_view_set_fov(scene_view_handle handle, float fov);
IBC_API bool scene_view_get_gizmos_visible(scene_view_handle handle);
IBC_API void scene_view_set_gizmos_visible(scene_view_handle handle, bool visible);
IBC_API bool scene_view_get_wireframe(scene_view_handle handle);
IBC_API void scene_view_set_wireframe(scene_view_handle handle, bool enabled);
