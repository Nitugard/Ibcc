...
#ifndef IBC_SOFTMATRIX_H
#define IBC_SOFTMATRIX_H
...
API sf_vec4 sf_mat_column_get(sf_mat4 const *a, i32 column);
API sf_vec4 sf_mat_row_get(sf_mat4 const *a, i32 row);
API void sf_mat_column_set(sf_vec4 const *a, i32 column, sf_mat4 *b);
API void sf_mat_row_set(sf_vec4 const *a, i32 row, sf_mat4 *b);
...
API sf_mat4 sf_mat_op_cumm(sf_mat4 const *a, sf_mat4 (*op)(sf_mat4 const*, sf_mat4 const*), i32 count);
API sf_mat4 sf_mat_op_cumm_variadic(sf_mat4(*op)(sf_mat4 const*, sf_mat4 const*), i32 count, ...);

#endif //IBC_SOFTMATRIX_H
